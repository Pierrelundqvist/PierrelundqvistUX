...
// ====== Bild-imports (lägg dina filer i src/assets/projects/examensarbete/) ======
...
// 🔹 Prototyp-bilder till karusellen i Process
...
// Liten card-komponent så vi återanvänder stilen
...
// Liten komponent för teammedlemmar (samma som i Kurr)
...
export const Examensarbete = () => {
  ...
  // 🔧 Avaktivera RevealOnScroll i mobilläge (≤768px) – samma som i Kurr
  ...
  const Wrapper = disableReveal ? Fragment : RevealOnScroll;

  // 🔹 Bilder till prototyp-karusellen i Process
  ...
  // 🔹 Bilder till karusellen i Resultat (shot1–3)
  ...
  // 🔹 Lightbox-state för klickbara bilder (som i Kurr)
  const [lightboxImage, setLightboxImage] = useState(null); // { src, alt } eller null
  ...
  return (
    <main className="min-h-screen py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
        {/* RevealOnScroll behöver exakt ett barn → wrappa allt i en div */}
        <Wrapper>
          <div>
            {/* Backlink */}
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Examensarbetet fokuserar på att förbättra trafiksäkerhet med hjälp
              av spelifiering. Genom återkoppling via ljud, ljus och
              vibrationer testade vi om spelmekanismer kan påverka förarbeteende
              i en bilsimulator. Projektet riktar sig mot framtidens fordon där
              föraren behöver hållas engagerad – även när bilen kör själv.
            </p>
              ...
              {tags.map((t) => (
                <span
                  ...
                  className="bg-blue-500/10 text-blue-300 py-1.5 px-3 rounded-full text-sm ring-1 ring-blue-400/20
                           hover:bg-blue-500/20 hover:ring-blue-400/30 hover:-translate-y-0.5 transition-all"
                >
                  {t}
                </span>
              ))}
            ...
            <div className="rounded-2xl overflow-hidden border border-white/10 shadow-lg">
              <img
                ...
                onClick={() =>
                  openLightbox(cover, "Översiktsbild för examensarbetet")
                }
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              ...
              <Card className="md:col-span-2">
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-3">
                  <li>
                    ...
                    effekten av spelifiering i en körsimulator. För att möjliggöra
                    detta utvecklades flera datainsamlingsverktyg baserade på
                    tidigare forskning: en enkät för demografiska uppgifter, två
                    prototyper (med och utan spelifiering) samt en intervjuguide
                    för att fånga deltagarnas upplevelser.
                  </li>

                  <li>
                    <strong>Pilotstudie:</strong> En pilotstudie genomfördes först
                    med två deltagare för att testa utrustning,
                    simulatorinställningar, spelmekanik och frågeformulär. Under
                    pilotfasen justerades bland annat den haptiska
                ...
                {/* 🔹 Prototyp-karusell – ovanför "Genomförande i simulator" */}
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-3">
                  <li>
                    <strong>Genomförande i simulator:</strong> Deltagarna körde i
                    en körsimulator i ett scenario på en ”oändlig motorväg”. Den
                    kvantitativa datan samlades in genom att mäta hur länge
                ...
                <ul className="text-gray-300 space-y-4">
                  ...
                  <li>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      ljus, vibration) och hur dessa påverkar förarens
                      upplevelse.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <p className="text-sm text-gray-400">
                      Deltog i både kvantitativ och kvalitativ analys av
                      insamlad data, identifierade mönster och formulerade
                      slutsatser.
                    </p>
                  </li>
                </ul>
              ...
              {/* ===== RESULTAT-KORT MED SHOT1–3-KARUSELL ===== */}
              <Card className="md:col-span-3">
                <h3 className="text-xl font-bold mb-3">Resultat</h3>

                {/* Karusell med shot1–3 ovanför texten */}
                ...
                <div className="text-gray-300 space-y-4 leading-relaxed">
                  <p>
                    ...
                    auditiv och haptisk återkoppling) och en utan
                    spelifiering.
                  </p>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-1 text-sm">
                      ...
                      <li>
                        Ett t-test visade <strong>ingen statistiskt
                        signifikant skillnad</strong> mellan grupperna
                        (p = 0,145).
                      </li>
                      <li>
                        Slutsats: spelifieringen gav <strong>ingen tydlig
                        förbättring</strong> av handposition i detta
                        experiment.
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-1 text-sm">
                      <li>
                        ...
                        hastighet och skillnader mellan simulator och verklig
                        bil påverkade upplevelsen.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        upplevdes både som distraherande och som en “morot”
                        – den hjälpte flera att korrigera sittställning men
                        var ibland väl intensiv.
                      </li>
                    </ul>
                  </div>
                  ...
                  <p className="text-sm text-gray-400">
                    ...
                    inte gav någon mätbar effekt på handposition, men gav
                    viktiga insikter om hur feedback, svårighetsgrad och
                    simulatorupplevelse behöver utformas för att stödja
