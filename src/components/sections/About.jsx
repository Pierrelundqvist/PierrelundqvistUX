          ...
          <div className="rounded-2xl p-8 border border-white/10 bg-white/5 backdrop-blur-sm shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
            <p className="text-gray-300 mb-8 leading-relaxed">
              <span className="block">
                UX-designer med bakgrund inom informatik och användarcentrerad
                design.
              </span>
              <span className="block mt-2">
                Jag arbetar med research, prototyping och gränssnittsdesign för
                att skapa skalbara och användarvänliga digitala lösningar.
              </span>
              <span className="block mt-2 text-gray-400">
                Genom akademiska projekt och samarbeten med externa organisationer
                har jag erfarenhet av att omsätta insikter till konkreta
                designbeslut i nära samarbete med både användare och utveckling.
              </span>
            </p>
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    Stationsvärd och bemanningskoordinator på MTR Nordic (2018–Nu)
                  </h4>
                  <p>
                    Har hand om försäljning, information och säkerhet för resande
                    inom tunnelbanan. Schemalägger personal i alla spärrar i
                    Stockholms tunnelbana.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold">
                    Servitör på Le Petit Prince (2017–2018)
                  </h4>
                  <p>
                    Jobbade som servitör i Frankrike på ett hotell under
                    skidsäsong fram tills april.
                  </p>
                </div>
              </div>
            </div>
